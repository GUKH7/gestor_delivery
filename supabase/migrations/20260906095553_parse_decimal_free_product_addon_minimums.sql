-- Reinstall the automatic free-product guards with defensive numeric parsing.
-- Legacy add-on minimums may be decimal/scientific strings and must never abort an upgrade.
